...
<div class="container-fluid text-center"id="primary"><!--Primary Id-->
  ...
  $sql= mysqli_query($con,"select * from room_booking_details where id='$eid' ");
  ...
  if(isset($savedata))
  {
    $sql= mysqli_query($con,"select * from room_booking_details where id='$eid' and room_type='$room_type' ");
